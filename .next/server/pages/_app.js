...
module.exports = {
	...
	"formSubmitLocked": "ErrorBoundary_formSubmitLocked__Zmg3M",
	"formInput": "ErrorBoundary_formInput__TO5p4",
	"formInputLocked": "ErrorBoundary_formInputLocked__R3O81",
...
// Exports
module.exports = {
	"formSubmit": "Error_formSubmit__Jsfi3",
	"formSubmitLocked": "Error_formSubmitLocked__5I8_F",
	"formInput": "Error_formInput__uzzeC",
	"formInputLocked": "Error_formInputLocked__DD1Li",
	"formInpDiv": "Error_formInpDiv__Q7N3P",
	"formNotification": "Error_formNotification__PfTBE",
	"formInpRow": "Error_formInpRow__kQCMd",
	"optionCard": "Error_optionCard__PX7Gb",
	"Selected": "Error_Selected__pBH3O",
	"SelectedLocked": "Error_SelectedLocked__4OwKy",
	"cardFooter": "Error_cardFooter__z7R7L",
	"innerCard": "Error_innerCard__Rv_eo",
	"optionCards": "Error_optionCards__I_uON",
	"card": "Error_card__PCviZ",
	"cardLocked": "Error_cardLocked__nQhka",
	"counter": "Error_counter__wQSEa",
	"data": "Error_data__7PxJ5",
	"error": "Error_error__2A9hG",
	"errorHeading": "Error_errorHeading__g3h5p",
	"errorAction": "Error_errorAction__9atBy"
};
...
var Button = __webpack_require__(7120);
// EXTERNAL MODULE: ./components/error/Error.module.scss
var Error_module = __webpack_require__(8058);
var Error_module_default = /*#__PURE__*/__webpack_require__.n(Error_module);
;// CONCATENATED MODULE: ./components/error/Error.jsx
...
function Error() {
    const renderErrorActions = ()=>{
        ...
        ].map((action)=>/*#__PURE__*/ jsx_runtime_.jsx("li", {
                className: (Error_module_default()).errorAction,
                children: action
            }, action)
        );
    };
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("h1", {
                className: (Error_module_default()).errorHeading,
                children: "Something went wrong. Perform the following actions:"
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("ul", {
                className: (Error_module_default()).errorActions,
                children: renderErrorActions()
            })
        ]
    });
};
...
var ErrorBoundary_module = __webpack_require__(4961);
...
var avaxapeContext = __webpack_require__(8324);
...
var __webpack_exports__ = __webpack_require__.X(0, [662], () => (__webpack_exec__(9317)));
