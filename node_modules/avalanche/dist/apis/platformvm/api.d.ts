...
export declare class PlatformVMAPI extends JRPCAPI {
     ...
     * @returns An unsigned transaction created from the passed in parameters.
     */
    buildCreateChainTx: (utxoset: UTXOSet, fromAddresses: string[], changeAddresses: string[], subnetID?: string | Buffer, chainName?: string, vmID?: string, fxIDs?: string[], genesisData?: string | GenesisData, subnetAuth?: SubnetAuth, memo?: PayloadBase | Buffer, asOf?: BN) => Promise<UnsignedTx>;
    /**
     * @ignore
     */
